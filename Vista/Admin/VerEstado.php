      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12 mx-auto">
            <a class=" float-left" href="Consulta.php"><img  src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Back_Arrow.svg/240px-Back_Arrow.svg.png" width="60" height="60" class="img-fluid " data-toggle="tooltip" title="Regresar a consulta"></a>
            ...
            <h2 class="text-center m-3">Avances del Candidato</h2>    
          </div>
        </div>
      </div>
    </header>
