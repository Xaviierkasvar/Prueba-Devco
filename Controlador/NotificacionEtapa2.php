  ...
  $body = [
    'Messages' => [
      [
        ...
        'TextPart' => "¡FELICIDAES!",
        'HTMLPart' => "<h3>Nos complace informarte tu avance satisfactorio en el proceso de selección a La etapa 2<br />Muy pendiente a los canales dispuestos te estaremos informando del agendamiento a la presentacion de las pruebas psicológica y entrevista médica",
